...
class DataStore {
    ...
    func fetchData ()
    {
        ...
        let newMessage = NSFetchRequest.init(entityName: "Message")
        do {
            self.messages = try self.managedObjectContext.executeFetchRequest(newMessage) as! [Message]
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("slapChat")
